...
export default class Incellderm extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Container fluid className="gradient">
          ...
          <Col>
            ...
            >
              ...
              <Navbar.Collapse id="navbarScroll">
                <Nav fill variant="tabs" defaultActiveKey="/incellderm">
                  <NavLink
        ...
        <Row>
          ...
          <Col xs s md="11" lg xl xxl="10">
            <Row>
              <h2 className="inventory_brand_name">{username}'s Incellderm</h2>
            </Row>
            <Row>
